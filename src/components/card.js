...
class Card extends Component {
    render() {
        return (
            <div className="col"><div class="card" style={{ width: "18rem", textAlign: "center", }}>
                <button onClick={()=>this.props.onIncrement(this.props.card)} className="btn btn-primary">Aggiungi<span className='badge bg-secondary'>{this.props.card.quantità}</span></button>
