...
import rainbow from "./images/california.png";
...
class App extends Component {
  state = {
    cards: [
      ...
      { id: 4, nome: "Rainbow", prezzo: 2.99, immagine: philadelphia, quantità: 0 },
      { id: 5, nome: "Gambero", prezzo: 1.49, immagine: shrimp, quantità: 0 },
    ]
  }
